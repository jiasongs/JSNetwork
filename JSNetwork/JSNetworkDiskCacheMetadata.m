...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:@(_stringEncoding) forKey:NSStringFromSelector(@selector(stringEncoding))];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super init]) {
        ...
        _stringEncoding = [[aDecoder decodeObjectOfClass:[NSNumber class] forKey:NSStringFromSelector(@selector(stringEncoding))] integerValue];
